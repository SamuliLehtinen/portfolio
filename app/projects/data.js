...
export const projects = [
    ...
    },
    {
      ...
      description: "Projet de groupe qui vise à la création de micro-services permettant de créer un système autonome une fois déployé. \nCréation d'un chatbot autonome ainsi que d'un système d'analyse de document manuscrit par OCR.",
      link: "https://github.com/MindForge-Innovations/monorepo",
      technologies: ["Python", "Docker", "Kubernetes", "API"], 
    },
    {
